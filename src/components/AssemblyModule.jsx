...
const AssemblyModule = () => {
  ...
  //     if (val > 50.30 || val < 50.15) {
  //         const seed = (val * 1000) + index;
  //         const pseudoRandom = Math.abs(Math.sin(seed)); 
  //         return Number((pseudoRandom * (50.30 - 50.15) + 50.15).toFixed(2));
  //     }
  //     return val;
  // };
  const clampOp10Dia1 = (val) => val;

  // Helper for Dia 2 & 3 [50.05, 50.20]
  ...
  // const clampOp10Dia23 = (val, index) => {
  //     if (val === null || val === undefined) return val;
  //     if (val > 50.20 || val < 50.05) {
  //         const seed = (val * 1000) + index;
  //         const pseudoRandom = Math.abs(Math.sin(seed)); 
  //         return Number((pseudoRandom * (50.20 - 50.05) + 50.05).toFixed(2));
  //     }
  //     return val;
  // };
  const clampOp10Dia23 = (val) => val;
                         ...
                         <div className="flex-1 min-h-0 flex flex-col gap-1">
                             ...
                             <div className="flex-[1] min-h-0">
                                 <LineChart 
                                     ...
                                     height="100%" 
                                    grid={{ right: 180, left: 10 }}
                                   yAxisConfig={{ min: -3, max: 3, interval: 1.5 }}
                                    markPoint={{
                                        symbol: 'circle',
                                        symbolSize: 0,
                                        label: {
                                      ...
                                      formatter: 'CPK:{c}',
                                        ...
                                        data: [
                                            // Vertically distributed between -3 and 3
